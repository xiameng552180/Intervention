...
{	
    ...
    // var url_list = ["https://pcrs.teach.cs.toronto.edu/csc108-2019-01-9901-dev/content/challenges/106/1",
    //                 "https://pcrs.teach.cs.toronto.edu/csc108-2019-01-9901-dev/content/challenges/36/1", 
    //                 "https://pcrs.teach.cs.toronto.edu/csc108-2019-01-9901-dev/content/challenges/39/1"]
    
    var url_list = ["https://pcrs.teach.cs.toronto.edu/csc108-2019-05/content/challenges/106/1",
                    "https://pcrs.teach.cs.toronto.edu/csc108-2019-05/content/challenges/36/1", 
                    "https://pcrs.teach.cs.toronto.edu/csc108-2019-05/content/challenges/39/1"]
    ...
    var challenge_text = [{'x': start_drawx + 40, 'y': first_row + 35, 'text': "Creating a", "font_size": "18px", "color": "black", "url": url_list[1]},
        {'x': start_drawx + 40, 'y': first_row + 60, 'text': "New Type", "font_size": "18px", "color": "black", "url": url_list[1]},
        {'x': start_drawx + 281, 'y': first_row + 35, 'text': "Writing Classes", "font_size": "18px", "color": "black", "url": url_list[2]},
        {'x': start_drawx + 281, 'y': first_row + 60, 'text': "that Interact", "font_size": "18px", "color": "black", "url": url_list[2]},
        {'x': start_drawx + 130, 'y': second_row + 35, 'text': "A Class to Manage a", "font_size": "18px", "color": "black", "url": ""},
        {'x': start_drawx + 130, 'y': second_row + 60, 'text': "Collection of Objects", "font_size": "18px", "color": "black", "url": ""},
