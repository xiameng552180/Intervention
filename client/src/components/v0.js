...
{					
  ...
  var legend_data = [
    {'x': 30, 'y': 10, 'width': 5, 'height': 60, 'color': incorrect},
    {'x': 180, 'y': 10, 'width': 5, 'height': 60, 'color': correct},
    {'x': 330, 'y': 10, 'width': 5, 'height': 60, 'color': '#fee08b'},
    // {'x': 480, 'y': 10, 'width': 5, 'height': 60, 'color': '#3182bd'},
  ];

  var text = [{'x': 0, 'y': first_row - 5, 'text': "Good students: more reflection time:"},
                {'x': 0, 'y': second_row - 5, 'text': "Your recent submission records:"},
                {'x': 0, 'y': third_row - 5, 'text': "Struggling students: less reflection time:"}]

  var legend_text = [{'x': 40, 'y': 50, 'text': "incorrect submission"},
                {'x': 190, 'y': 50, 'text': "correct submission"},
                {'x': 340, 'y': 50, 'text': "reflection time"},
                // {'x': 490, 'y': 40, 'text': "time needed"},
                // {'x': 490, 'y': 60, 'text': "for exam review"}
            ]
