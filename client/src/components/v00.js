...
{					
  ...
  var legend_data = [
    ...
    {'x': 315, 'y': 10, 'width': 60, 'height': 60, 'color': '#fee08b'},
    {'x': 480, 'y': 10, 'width': 60, 'height': 60, 'color': '#3182bd'},
  ];
  ...
  var legend_text = [{'x': 40, 'y': 50, 'text': "incorrect submission"},
                ...
                {'x': 385, 'y': 50, 'text': "reflection time"},
                {'x': 550, 'y': 40, 'text': "time needed"},
                {'x': 550, 'y': 60, 'text': "for exam review"}]
