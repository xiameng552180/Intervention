...
for item in recent_pro_game_hashed:
    print(len(item))
frequent_game = recent_pro_game_hashed[2] & recent_pro_game_hashed[3]
...
v0_still_544 = v0_people & recent_pro_game_hashed[0]
v1_still_544 = v1_people & recent_pro_game_hashed[0]
v2_still_544 = v2_people & recent_pro_game_hashed[0]
v3_still_544 = v3_people & recent_pro_game_hashed[0]

v0_still_327 = v0_people & recent_pro_game_hashed[1]
v1_still_327 = v1_people & recent_pro_game_hashed[1]
v2_still_327 = v2_people & recent_pro_game_hashed[1]
v3_still_327 = v3_people & recent_pro_game_hashed[1]

print(len(v0_frequent),len(v0_still_327), len(v0_still_327)/len(v0_frequent), len(v0_still_544), len(v0_still_544)/len(v0_frequent))
print(len(v1_frequent),len(v1_still_327), len(v1_still_327)/len(v1_frequent), len(v1_still_544), len(v1_still_544)/len(v1_frequent))
print(len(v2_frequent),len(v2_still_327), len(v2_still_327)/len(v2_frequent), len(v2_still_544), len(v2_still_544)/len(v2_frequent))
print(len(v3_frequent),len(v3_still_327), len(v3_still_327)/len(v3_frequent), len(v3_still_544), len(v3_still_544)/len(v3_frequent))
# print(frequent_game)
